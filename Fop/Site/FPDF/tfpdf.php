...
*                                                                              *
*******************************************************************************/
function tFPDF($orientation='P', $unit='mm', $size='A4',$pedidoExportar, $img, $tipoAnilha, $sigla, $nome_clube, $morada)
{
	// Some checks
	$this->_dochecks();
	...
	$this->ws = 0;
	$this->pedidoExportar = $pedidoExportar;
	$this->image = $img;
	$this->tipoAnilha = $tipoAnilha;
