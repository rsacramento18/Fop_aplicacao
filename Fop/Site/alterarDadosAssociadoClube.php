...
<?php if (login_check($dbc) == true) : ?>
	<div class="wrapper-content">
		...
		<script type="text/javascript"> 
			jQuery(function($) {
				var clube = "<?php echo $clube; ?>";
				var membroNum = "<?php echo $membroNum; ?>";
				...
				document.getElementById('membroNum').value = membroNum;
		...
		<div id="formEditarRegisto">
			<form action="alterarDadosAssociadoClube.inc.php" method="post" id="editarRegisto_socio">
				<input type="hidden" name="clube" id="clube"/><br/>
				<input type="text" placeholder="membroNum" size="50" name="membroNum" id="membroNum"/>
				<span class="labels2">Inserir novo número de associado.</span><br/>
