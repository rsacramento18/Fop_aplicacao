...
<?php if (login_check($dbc) == true) : ?>
	<div class="wrapper-content">
		...
		<div id="formEditarRegisto">
			<h2>Atenção:</h2>
			<p>O BI/CC não foi encontrado na base de dados. Se o associado já existir na base dados carregue no botão voltar para tentar novamente. Se tiver a certeza que o associado não consta na na base de dados carregue no botão adicionar novo utilizador.</p><br/>
			<p><b>Nota: </b>Se o numero de BI/CC comecar com um numero diferente de 0 tente outra vez adicionando 0 no início do número. Caso contrário remova o zero e tente novamente</p>
			<br/>
